...
<head>
    ...
    <title>Offshore Image Wall</title>

    <meta name="description" content="A full gallery of art for Offshore by Circlejourney, displayed as a tiling wall.">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta property="og:title" content="Offshore Image Wall" />

    <meta property="og:type" content="website" />

    <meta property="og:url" content="https://circlejourney.net/offshore/wall" />
    ...
    if (isset($_GET["img"])) {
        ...
        echo "<meta property='og:image' content='https://circlejourney.net/offshore/wall/images/$thumburl' />";
    } else {

        echo '<meta property="og:image" content="https://circlejourney.net/offshore/wall/thumbs/cover_thumb.jpg" />';
    }
    ...
    <script>
        ...
        let promises = [
            ...
            $.getJSON(
                ...
                "imagefilter.php" + location.search,
                function(d) {
        ...
        Promise.all(promises).then(function() {
            ...
            if (img) {
                ...
                for (let k in taglist) {
                    ...
                    if (taglist[k].length > 0) {
                        ...
                        taglist[k].forEach(function(val, i) {
                            ...
                            const tagbuttonparams = {
                                ...params,
                                tags: tagstring,
                                extags: toggleextagstring
                            };

                            const extagbuttonparams = {
                                ...params,
                                extags: extagstring,
                                tags: toggletagstring
                            };
                ...
                if (sortInvert.sort == "d") delete sortInvert.sort;
                ...
                $(tagExtras).append(
                    ...
                    `<span class='tag-wrapper'>
                            ...
                            <a class='tag-button' href='?${ serialise(sortInvert) }'>Sort ${sort == "d" ? "&#9650;" : "&#9660;"} </span></a>
...
<body>
    ...
    <h1 class="title"><a href='./'>Offshore Image Wall</a></h1>
