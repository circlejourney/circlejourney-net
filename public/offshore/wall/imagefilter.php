<?php
    ...
    $tagroot = "tag-info/";
    $perPage = 30;
    $imagelist = json_decode( file_get_contents("imagelist.json"), $associative = true );
    $taginfo = json_decode( file_get_contents("tags.json"), $associative = true );

    // SORT
    $sortFn = array();
    $sortFn["d"] = function($a, $b) {
