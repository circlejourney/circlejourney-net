...
@section("content")
    ...
    <form action="" method="post" class="editor">
        ...
        <input class="editor-text" type="text" id="thumb_src" name="thumb_src" value="{{ $artwork->thumb_src }}" placeholder="Thumbnail source URL">
        <input class="editor-text" type="text" id="img_src" name="img_src" value="{{ $artwork->img_src }}" placeholder="Image source URL" onchange="$('#preview-image').attr('src', this.value);">
